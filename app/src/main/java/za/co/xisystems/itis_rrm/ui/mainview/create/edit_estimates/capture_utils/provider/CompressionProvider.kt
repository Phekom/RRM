...
import za.co.xisystems.itis_rrm.ui.mainview.create.edit_estimates.capture_utils.util.ExifDataCopier
import za.co.xisystems.itis_rrm.ui.mainview.create.edit_estimates.capture_utils.util.FileUtil
import za.co.xisystems.itis_rrm.ui.mainview.create.edit_estimates.capture_utils.util.ImageUtil
...
class CompressionProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    private fun applyCompression(file: File, attempt: Int): File? {
        ...
        if (mMaxWidth > 0 && mMaxHeight > 0 &&
            (maxWidth > mMaxWidth || maxHeight > mMaxHeight)
        ) {
