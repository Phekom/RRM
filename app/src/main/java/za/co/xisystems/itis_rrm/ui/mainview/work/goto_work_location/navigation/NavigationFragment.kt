...
//import za.co.xisystems.itis_rrm.databinding.NavigationFragmentBinding
//import za.co.xisystems.itis_rrm.ui.scopes.UiLifecycleScope
//import za.co.xisystems.itis_rrm.utils.Coroutines
//
//
//class NavigationFragment : BaseFragment(), DIAware,
...
//    private var _ui: NavigationFragmentBinding? = null
//    private val ui get() = _ui!!
//    private var myCurrentRoute: DirectionsRoute? = null
...
//    ): View {
//        _ui = NavigationFragmentBinding.inflate(inflater, container, false)
//        return ui.root
//
//    }
//
...
//         Coroutines.main {
//                navViewModel.route.value.also {
//                myCurrentRoute = it
//                //ToastUtils().toastShort(requireContext(), it.toString())
//
//                navigationview = _ui?.routenavigationview
//
...
//                navigationview?.retrieveMapboxNavigation()?.let { mapboxNavigation = it }
//                val optionsBuilder = NavigationViewOptions.builder(ACTIVITY)
//                optionsBuilder.navigationListener(this)
//                optionsBuilder.directionsRoute(route)
//                optionsBuilder.shouldSimulateRoute(true)
//                optionsBuilder?.build()?.let { navigationview!!.startNavigation(it) }
//
//
//            }
//        }
...
//        //Todo: keep the user everything here
...
//        ToastUtils().toastShort(requireContext(), "You canceled")
...
//        private const val MIN_SECONDS = 1.0
