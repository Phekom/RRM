...
//            rootDirectory = context.getExternalFilesDir("RRM Data")
//        }
        if (folderTitle == null) {
            folderTitle = resource.getString(R.string.title_folder)
        }
        if (imageTitle == null) {
            imageTitle = resource.getString(R.string.title_image)
        }
        if (doneTitle == null) {
            doneTitle = resource.getString(R.string.action_done)
        }
