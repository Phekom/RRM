 ...
 * Last modified on 2021/05/14, 22:06
...
/**
 * Created by Shaun McDonald on 2020/04/18.
...
class ForegroundOnlyLocationService : Service() {
    ...
    override fun onCreate() {
        ...
        locationRequest = LocationRequest().apply {
            ...
            // Throttle rate - interval is exact, updates will never be
            // faster than the rate set here.
    ...
    companion object {
        ...
        private const val PACKAGE_NAME = "package za.co.xisystems.itis_rrm.services"
