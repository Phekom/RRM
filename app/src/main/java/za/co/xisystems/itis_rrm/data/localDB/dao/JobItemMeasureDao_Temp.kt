...
//    fun upDatePhotList(jobItemMeasurePhotoList: ArrayList<JobItemMeasurePhotoDTOTemp>, itemMeasureId: String)
//
...
//
//    @Query("DELETE FROM JOB_ITEM_MEASURE_TEMP WHERE ItemMeasureId = :ItemMeasureId")
