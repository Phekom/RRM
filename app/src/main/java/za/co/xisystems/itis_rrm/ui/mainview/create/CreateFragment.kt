...
//            contrct.observe(viewLifecycleOwner, Observer {
//                                context?.toast(it.size.toString())
//////                TextLabel.setText(voItems.toString())
//
//
//
//
//            })
            ...
            val contrct = homeViewModel.offlinedata.await()
            val item = arrayOf<String>(contrct.toString())
...
//            adapter =
//                ArrayAdapter<String>(context, android.R.layout.simple_spinner_dropdown_item, contracts)
//
//            contractSpinner.setAdapter(adapter)

//            contractSpinner.setOnItemSelectedListener(object : AdapterView.OnItemSelectedListener {
//                override fun onItemSelected(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
//                    val selectedDivision = contracts[i]
//                    if (i == 0) {
