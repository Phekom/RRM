...
public class ITISTextView extends EditText {
    ...
    public ITISTextView(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public ITISTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.attrs = attrs;
        init();
    ...
    public ITISTextView(Context context, AttributeSet attrs, int defStyleAttr) {
